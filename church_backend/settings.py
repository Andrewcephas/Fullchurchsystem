...
CORS_ALLOWED_ORIGINS = os.environ.get(
    ...
    'http://localhost:8080,http://127.0.0.1:8080,https://churchsystem.vercel.app'
).split(',')
...
CSRF_TRUSTED_ORIGINS = os.environ.get(
    ...
    'http://localhost:3000,http://localhost:5173,http://localhost:8080,https://churchsystem.vercel.app'
).split(',')
